...
class SiHalal extends Page implements HasTable
{
    ...
    protected static ?string $title = 'Data Sinkronisasi JotForm';
    ...
    protected function checkHalalGoIdToken(): array
    {
        try {
            ...
            if (
                ...
                return [
                    'valid' => false,
                    'message' => 'Token Halal.go.id sudah kadaluarsa atau tidak valid. Silakan update token baru di halaman Settings.'
                ];
            }
